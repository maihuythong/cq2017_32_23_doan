...
public class ShowSystemStopPointPopup extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    ArrayList<StopPoint> addedStopPoints  = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_stop_point_system_popup);
        ...
        findViewById(R.id.finish_adding).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                returnIntent.putExtra("added_stop_points", addedStopPoints);
    ...
    private class LoadStopPointSystemAsyncTask extends AsyncTask<Void, Void, Void>{
        ...
        LoadStopPointSystemAsyncTask(ShowSystemStopPointPopup activity) {
                ...
                if(response.code()==200)
                {
                    ...
                    lvStopPoints.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            addedStopPoints.add(totalStopPointArray.get(position));
                        }
                    });
    ...
    private void showInfoStopPoint(ArrayList<StopPoint> arrayList,int position){
        ...
        Intent intent = new Intent(getApplicationContext(), ShowSPInformation.class);
