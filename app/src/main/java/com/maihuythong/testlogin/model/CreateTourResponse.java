...
public class CreateTourResponse {
    ...
    public Number gethostId(){return hostId;}
    public void setHostId(Number host){hostId=host;}

    public Number getStatus(){return status;}
    public void setStatus(Number state){status=state;}
    ...
    public void setId(Number setId){id =setId ;}
